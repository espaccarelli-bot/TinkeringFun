...
# I think it will count the number of evens
# 2. Set a breakpoint or add a print statement.
# I added one that prints the even count as it gose
# 3. Change one small thing and rerun.
#  It worked! Im a geinus. 
# 4. Compare your prediction to the actual result.
# It was cool to see the numbers go up like I thought
# 5. Ask: "What changed, and why?"
# It printed every time it counted a new even and Printed NA when it didn't
#
# Helpful questions:
